...
class _CustomerOrderViewState extends State<CustomerOrderView> {
  ...
  TextEditingController _transactionDate = new TextEditingController();
  TextEditingController _contactPerson = new TextEditingController();
  TextEditingController _contactNo = new TextEditingController();
  TextEditingController _purpose = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final CustomerOrderProvider _customerOrderProvider =
        CustomerOrderProvider();
    final CompanyNameProvider _companyNameProvider = CompanyNameProvider();
    _name.text = widget.customerOrder.name;
    _description.text = widget.customerOrder.description;
    ...
    initState() async {
      super.initState();
      final result = await _customerOrderProvider.getAllCustomerOrderProvider();
    }
                ...
                children: <Widget>[
                  ...
                  textFormFeild(
                      onTap: () async {
                        ...
                        _transactionDate.text = date.toIso8601String();
                      },
                      readOnly: _readOnly,
                      ...
                      validate: (String value) {
                        ...
                        if (value.length == 0) {
                          ...
                          return "Transaction Date must be Need";
                        }
                        return null;
                      },
                  ...
                  textFormFeild(
                      onTap: null,
                      readOnly: _readOnly,
                      title: widget.customerOrder.name,
                      validate: (String value) {
                        String patttern = r'';
                        RegExp regExp = new RegExp(patttern);
                        if (value.length == 0) {
                          return "CustomerOrder is Required";
                        } else if (!regExp.hasMatch(value)) {
                          return "CustomerOrder must be Need";
                        }
                        return null;
                      },
                      controller: _name,
                  ...
                  textFormFeild(
                    readOnly: _readOnly,
                    title: widget.customerOrder.description,
                    validate: (String value) {
                      String patttern = r'';
                      RegExp regExp = new RegExp(patttern);
                      if (value.length == 0) {
    ...
    void CustomerOrderUpdate() async {
      ...
      switch (widget.control) {
        case 'add':
          ...
          break;
        case 'edit':
          result = await _customerOrderProvider.updateCustomerOrderProvider(
